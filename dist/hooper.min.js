          ...
          trackTransform: function() {
            var t = this.config,
              ...
              a =
                ...
                r * ((o ? (h - s) / 2 : 0) - (i ? s * this.slidesCount : 0) - this.currentSlide * s);
            ...
            if (!this.isSliding && t !== this.currentSlide) {
              ...
              this.group && n && f.$emit('slideGroup:'.concat(this.group), t),
                ...
                window.setTimeout(function() {
                  (e.isSliding = !1), (e.currentSlide = l(a, e.slidesCount));
                }, s),
                      ...
                      (o = (function(t, i) {
                        for (var e = [], n = [], o = i.length, r = 0; r < o; r++) {
                          var s = i[r],
                            h = d(t, s),
                            a = r - o;
                          (h.data.key = 'before_'.concat(r)),
                            (h.key = h.data.key),
                            (h.componentOptions.propsData.index = a),
                            (h.data.props = { index: a, isClone: !0 }),
                            e.push(h);
                          var l = d(t, s);
                          (a = r + o),
                            (l.data.key = 'after_'.concat(a)),
                            (l.componentOptions.propsData.index = a),
                            (l.key = l.data.key),
                            (l.data.props = { index: a, isClone: !0 }),
                            n.push(l);
                        }
        ...
        computed: {
          ...
          isActive: function() {
            var t = this.$hooper.slideBounds,
              ...
              o = t.slidesCount;
            return e === -n
              ? (this.index >= e && this.index <= i) || (this.index >= e + n && this.index <= i + n)
              : e === o
              ? (this.index >= e && this.index <= i) || (this.index >= e - o && this.index <= i - o)
              : this.index >= e && this.index <= i;
          },
          isPrev: function() {
