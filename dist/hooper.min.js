...
(t = this),
  (i = function(t, i) {
        ...
        for (var i = Object(t), e = 1; e < arguments.length; e++) {
          ...
          if (null != n) {
            ...
            for (var r = Object.keys(Object(n)), o = 0, s = r.length; o < s; o++) {
              var h = r[o],
                a = Object.getOwnPropertyDescriptor(n, h);
              void 0 !== a && a.enumerable && (i[h] = n[h]);
            }
          }
        }
        return i;
      ...
      s = {
        ...
        computed: {
          trackTransform: function() {
            var t = this.config,
              ...
              h = e ? this.containerHeight : this.containerWidth,
              a =
                (e ? this.delta.y : this.delta.x) +
                o * ((r ? (h - s) / 2 : 0) - (i ? s * this.slidesCount : 0) - this.currentSlide * s);
            return e ? 'transform: translate(0, '.concat(a, 'px);') : 'transform: translate('.concat(a, 'px, 0);');
          },
          trackTransition: function() {
            return this.isSliding ? 'transition: '.concat(this.config.transition, 'ms') : '';
          }
        },
        watch: {
          group: function(t, i) {
            t !== i && (p.$off('slideGroup:'.concat(i), this._groupSlideHandler), this.addGroupListeners());
          }
        },
        methods: {
          slideTo: function(t, i) {
            ...
            if (!this.isSliding && t !== this.currentSlide) {
              this.$emit('beforeSlide', { currentSlide: this.currentSlide, slideTo: a });
              var r = this.config,
                o = r.infiniteScroll,
                s = r.transition,
                h = this.currentSlide,
              ...
              this.group && n && p.$emit('slideGroup:'.concat(this.group), t),
                (this.currentSlide = a),
                (this.isSliding = !0),
                window.setTimeout(function() {
                  (e.isSliding = !1), (e.currentSlide = u(a, e.slidesCount));
                }, s),
                this.$emit('slide', { currentSlide: this.currentSlide, slideFrom: h });
            }
          },
          slideNext: function() {
          ...
          addGroupListeners: function() {
            ...
            this.group &&
              ...
              p.$on('slideGroup:'.concat(this.group), this._groupSlideHandler));
          }
        },
        created: function() {
          this.initDefaults();
        ...
        mounted: function() {
          ...
          this.initEvents(),
            ...
            this.$nextTick(function() {
              t.update(), t.slideTo(t.config.initialSlide || 0), t.$emit('loaded');
            });
        },
        beforeDestroy: function() {
          window.removeEventListener('resize', this.update),
            ...
            this.group && p.$off('slideGroup:'.concat(this.group), this._groupSlideHandler),
        ...
        render: function(t) {
          var i = this,
            e = function(t) {
              var i = function(t) {
                  for (var i = f(this), e = i.length, n = 0, r = [], o = 0; o < e; o++) {
                    var s = i[o],
                      h = s.componentOptions && s.componentOptions.Ctor;
                    h &&
                      'HooperSlide' === h.options.name &&
                      ((s.componentOptions.propsData.index = n),
                      (s.data.key = n),
                      (s.key = n),
                      (s.data.props = a({}, s.data.props || {}, { isClone: !1, index: n++ })),
                      r.push(s));
                  }
                    ...
                    this.config.infiniteScroll &&
                      (r = (function(t, i) {
                        for (var e = [], n = [], r = i.length, o = 0; o < r; o++) {
                          var s = i[o],
                            h = d(t, s);
                          (h.data.key = 'index-'.concat(o - r)),
                            (h.key = h.data.key),
                            (h.data.props = { index: o - r, isClone: !0 }),
                            e.push(h);
                          var a = d(t, s);
                          (a.data.key = 'index-'.concat(o + r)),
                            (a.key = a.data.key),
                            (a.data.props = { index: o + r, isClone: !0 }),
                            n.push(a);
                        }
    ...
    var h = {
        name: 'HooperSlide',
        inject: ['$hooper'],
        props: { isClone: { type: Boolean, default: !1 }, index: { type: Number, default: 0, required: !0 } },
        computed: {
          style: function() {
            var t = this.$hooper || {},
              i = t.config,
          ...
          lower: function() {
            var t = this.$hooper || {},
              ...
              e = t.currentSlide,
              n = i.itemsToShow;
            return i.centerMode ? Math.ceil(e - n / 2) : e;
          },
          upper: function() {
            var t = this.$hooper || {},
              i = t.config,
              e = t.currentSlide,
              n = i.itemsToShow;
            return i.centerMode ? Math.floor(e + n / 2) : Math.floor(e + n - 1);
          },
          isActive: function() {
